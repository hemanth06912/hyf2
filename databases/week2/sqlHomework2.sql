-- create database hyf_db_homework2;
 use hyf_db_homework2;
-- CREATE TABLE `user` (
...
-- insert into task (id, title, description, created, updated, due_date, status_id, user_id) values (35, 'Learn about NoSQL databases', 'MongoDB, CouchDB, etc.', '2017-10-20 01:41:53', '2017-10-04 07:19:56', '2017-12-23 10:13:42', 2, NULL);
 ...
 -- select * from task;
-- inserted some values --task1
-- insert into task (title,description,created,updated,due_date,status_id,user_id)
--  values ('walking','walking along the road in the city','2017-10-12 18:40:08','2018-1-2 18:40:08','2018-9-12 18:40:08', 3,4);

-- task 2 update:change the title
-- update task set title = 'walking alone' 
-- where id=31;

-- task3: change the due date
-- update task set due_date = '2019-10-5 22:52:01' 
-- where id=31;

-- task 4: change the status
-- update task set status_id=1
-- where id=31;

-- task5: make status complete
-- update task set status_id =3
-- where id=31;

-- task 6: delete the task
-- delete from task  
-- where id=31;
